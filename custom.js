...
function onSuccess(movie) {
	...
	elem += "<img src='" + movie.Poster + "'>";
	elem += "<div class='title'>" + movie.Title + "</div>";
	elem += "<div class='director'><em>Director:</em> " + 
	        movie.Director + "</div>";
	elem += "<div class='actors'><em>Actors:</em> " + 
	        movie.Actors + "</div>";
	elem += "<div class='country'>" + movie.Country + "</div>";
	elem += "<div class='year'>" + movie.Year + "</div>";
	elem += "<div class='genre'>" + movie.Genre + "</div>";
	elem += "</div>";
